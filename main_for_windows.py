...
class Header(QWidget):
    ...
    def initUI(self):
        ...
        headerLayout.setContentsMargins(50, 50, 50, 50)
...
class Content(QWidget):
    ...
    def initUI(self):
        ...
        guide.setContentsMargins(0, 0, 0, 10)
        ...
        nameLayout.setContentsMargins(0, 40, 0, 20)
        ...
        addressLayout.setContentsMargins(0, 0, 0, 20)
        ...
        self.parent.download.setFixedWidth(200)
        self.parent.download.setFixedHeight(80)
        ...
        # 푸터
        footer = QHBoxLayout()
        footer.setContentsMargins(0, 80, 0, 0)
        ...
        child.setContentsMargins(50, 50, 50, 50)
