...
<p align="center">
    <img src="/guide/main_screenshot_mac.png" width="90%" alt="메인 화면 (맥)">
    <img src="/guide/main_screenshot_windows.png" width="85%" alt="메인 화면 (윈도우)">
</p>
...
위 사진과 같이 보안 경고가 뜬다면 '설정' > '보안 및 개인 정보 보호'에서 '확인 없이 열기'를 클릭합니다. 소스 코드도 같이 공개하였기때문에 바이러스 걱정은 전혀 안 해도 됩니다!

## 설치 중 문제가 생기다면 (Windows)
<p align="center">
    <img src="/guide/warning_windows.png" width="40%" alt="오류 (윈도우)">
</p>
위 사진과 같이 PC 보호 경고가 뜬다면 '추가 정보' > '실행'을 클릭합니다. 소스 코드도 같이 공개하였기때문에 바이러스 걱정은 전혀 안 해도 됩니다!
